...
from bot import create_bot_app, setup_menu_button, setup_commands, broadcast_alert
...
if __name__ == "__main__":
    ...
    uvicorn.run("main:app", host="0.0.0.0", port=port, reload=False)        await bot_app.stop()
        await bot_app.shutdown()
        logger.info("Bot stopped")
